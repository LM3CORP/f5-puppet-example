...
RSpec.configure do |c|
  ...
  c.before :suite do
    ...
    ignore_list = build_ignore_list({ ignore_list: ['development/modules','.bundle','.git','.idea','.vagrant','acceptance','spec','log','example','tests'] })
    #copy my wrapper module
    copy_module_to(master, :source => proj_root, :module_name => 'lm3_f5', :ignore_list => ignore_list )
    #copy the third-party f5 dependency
    copy_module_to(master, :source => 'development/modules/f5_puppet', :module_name => 'f5')
